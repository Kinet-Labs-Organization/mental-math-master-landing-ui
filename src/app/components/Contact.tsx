      ...
      <div className="pt-32 pb-20 px-4 relative">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="text-6xl md:text-7xl mb-6 text-white font-black">Get in Touch! 💌</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <Card className="bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-sm border-2 border-pink-500/30">
                <CardHeader>
                  <CardTitle className="text-white text-3xl font-bold">Send Us a Message 📨</CardTitle>
